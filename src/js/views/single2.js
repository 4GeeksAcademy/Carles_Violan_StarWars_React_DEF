...
export const Single2 = props => {
	...
	const imageUrl = `https://starwars-visualguide.com/assets/img/planets/${parseInt(params.theid) + 1}.jpg`;
	return (
		<div className="container">
			<div className="container-fluid">
						...
						<div className="col-sm-3 col-md-6 col-lg-4">
									...
									{ <img src={imageUrl} alt={store.planetas[params.theid].name} style={{ width: '100%' }} /> }
